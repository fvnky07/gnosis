...
import { Separator } from "@gnosis/ui/components/separator";
...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: shadcn field composes div with role=group rather than fieldset to allow non-form usage
		<div
			role="group"
			data-slot="field"
