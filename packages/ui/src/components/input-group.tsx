...
import { Textarea } from "@gnosis/ui/components/textarea";
...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: shadcn input-group composes div with role=group
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: shadcn addon composes div with role=group
		// biome-ignore lint/a11y/useKeyWithClickEvents: addon proxies focus to inner input; keyboard already focuses input directly
		<div
			role="group"
